...
const data = [
  ...
  [false, -6, 'Watch an entire series in one weekend.'],
  [true, -5, 'Clean my desk. So that it gets sparkling!'],
  [false, -4, 'Eat too much pizza with No regrets.'],
  ...
  [false, +3, 'Create a todo list... for making more todo lists.'],
